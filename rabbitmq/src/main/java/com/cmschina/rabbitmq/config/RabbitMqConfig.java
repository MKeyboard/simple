...
public class RabbitMqConfig {
    ...
    public Queue businessQueueA(){
        ...
        // 声明当前队列的绑定的死信交换机
        args.put(ORDER_DEAD_LETTER_QUEUE_KEY,DEAD_LETTER_EXCHANGE);
        // 声明当前队列死信路由key
        args.put(ORDER_DEAD_LETTER_ROUTING_KEY,DEAD_LETTER_QUEUEA_ROUTING_KEY);
    ...
    public Queue businessQueueB(){
        ...
        args.put(ORDER_DEAD_LETTER_QUEUE_KEY,DEAD_LETTER_EXCHANGE);
        // 声明当前队列死信路由key
        args.put(ORDER_DEAD_LETTER_ROUTING_KEY,DEAD_LETTER_QUEUEB_ROUTING_KEY);
     ...
     */
    public static final String BUSINESS_ORDER_EXCHANGE = "business-order-exchange";
    ...
    public static final String DEAD_LETTER_ORDER_ROUTING_KEY = "dead-letter-order-routing-key";
